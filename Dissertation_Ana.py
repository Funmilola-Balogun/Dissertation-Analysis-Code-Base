...
"""### Adjusted Binary Target Threshold"""
...
"""### Table 2: Final Dataset Overview"""
...
table_2.to_excel(
    "Table_2_Final_Dataset_Overview.xlsx",
    index=False
)

print("Table 2 exported successfully to 'Table_2_Final_Dataset_Overview.xlsx'.")
...
"""### Dataset Suitability Statistics
...
"""### Create Dissertation Table 3 (Descriptive Statistics)"""
...
table_3.to_excel(
    "Table_3_Descriptive_Statistics.xlsx",
    index=False
)

print("\nTable 3 exported successfully to 'Table_3_Descriptive_Statistics.xlsx'.")
...
## 4.3 Distribution of Treatment Success
...
table_4.to_excel(
    "Table_4_Outcome_Distribution.xlsx",
    index=False
)
print("Table 4 exported successfully to 'Table_4_Outcome_Distribution.xlsx'.")
...
plt.savefig(
    'Figure_13_Outcome_Distribution.png',
    dpi=300,
    bbox_inches='tight'
)

print("Figure 13 saved to 'Figure_13_Outcome_Distribution.png'.")
plt.show()

"""## 4.4 Logistic Regression Model Development"""
...
# Export to Excel
metrics_df.to_excel("Table_5_Model_Performance_Metrics.xlsx", index=False)

print("\nModel performance metrics exported successfully to 'Table_5_Model_Performance_Metrics.xlsx'.")
...
plt.title("Figure 14 Confusion Matrix - Logistic Regression")
plt.savefig(
    'Figure_14_Confusion_Matrix.png',
    dpi=300,
    bbox_inches='tight'
)
print("Figure 14 Confusion Matrix saved to 'Figure_14_Confusion_Matrix.png'.")
plt.show()
...
plt.title("Figure 15 ROC Curve - Logistic Regression")
plt.legend()
plt.savefig(
    'Figure_15_ROC_Curve.png',
    dpi=300,
    bbox_inches='tight'
)
print("Figure 15 ROC Curve saved to 'Figure_15_ROC_Curve.png'.")
plt.show()
...
# Display the table
print("Dissertation Table 6: Logistic Regression Coefficients, Odds Ratios, and P-values")
display(table_data)

"""### Export Dissertation Table 6"""

table_data.to_excel(
    "Table_6_Logistic_Regression_Results.xlsx",
    index=False
)

print("Dissertation Table 6 exported successfully to 'Table_6_Logistic_Regression_Results.xlsx'.")

"""### Figure 16 Odds Ratios of Reduced Model Predictors"""
...
plt.title('Figure 16 Odds Ratios of Predictors')
...
plt.tight_layout()
plt.savefig(
    'Figure_16_Odds_Ratios.png',
    dpi=300,
    bbox_inches='tight'
)
print("Figure 16 Odds Ratios Plot saved to 'Figure_16_Odds_Ratios.png'.")
plt.show()
...
plt.title('Figure 17 Calibration Curve')

plt.legend()

plt.savefig(
    'Figure_17_Calibration_Curve.png',
    dpi=300,
    bbox_inches='tight'
)

print("Figure 17 Calibration Curve saved to 'Figure_17_Calibration_Curve.png'.")
...
"""### Export Dissertation Table 7"""

table_7.to_excel(
    "Table_7_Calibration_Measures.xlsx",
    index=False
)
print("Table 7 exported successfully to 'Table_7_Calibration_Measures.xlsx'.")
...
## 4.6 Linear Regression Model Development
"""
...
table_8.to_excel(
    "Table_8_Linear_Regression_Performance.xlsx",
    index=False
)

print("Table 8 exported successfully to 'Table_8_Linear_Regression_Performance.xlsx'.")
...
plt.title("Figure 18 Residual Plot - Linear Regression")

plt.savefig(
    'Figure_18_Residual_Plot.png',
    dpi=300,
    bbox_inches='tight'
)

print("Figure 18 Residual Plot saved to 'Figure_18_Residual_Plot.png'.")
plt.show()
...
plt.title("Figure 19 Q-Q Plot of Linear Regression Residuals")
plt.savefig(
    'Figure_19_QQ_Plot.png',
    dpi=300,
    bbox_inches='tight'
)
print("Figure 19 Q-Q Plot saved to 'Figure_19_QQ_Plot.png'.")
plt.show()
...
"""### Reduced Features for Linear Regression (OLS)"""
...
"""### Reduced Linear Regression Model Training (OLS)"""
...
"""### Reduced OLS Model Coefficients, Standard Errors, and P-values"""
...
results_table.to_excel(
    "Table_9_Linear_Regression_Coefficients.xlsx",
    index=False
)

print("Table 9 exported successfully to 'Table_9_Linear_Regression_Coefficients.xlsx'.")
...
vif_data.to_excel(
    "Table_10_VIF_Results.xlsx",
    index=False
)

print("Variance Inflation Factor (VIF) results exported successfully to 'Table_10_VIF_Results.xlsx'.")

"""## 4.7 Decision Curve Analysis (DCA)"""
...
plt.title('Figure 20 Decision Curve Analysis (Enhanced)')
...
plt.savefig(
    'Figure_20_Decision_Curve_Analysis_Enhanced.png',
    dpi=300,
    bbox_inches='tight'
)

print("Figure 20 Decision Curve Analysis Plot (Enhanced) saved to 'Figure_20_Decision_Curve_Analysis_Enhanced.png'.")
plt.show()

"""### Table 11: DCA Results for Selected Thresholds"""

selected_thresholds = [0.10, 0.20, 0.30, 0.40, 0.50]

table_11 = dca_results[
    dca_results['Threshold Probability'].round(2).isin(selected_thresholds)
].copy()

print("Table 11 created for selected thresholds:")
display(table_11)

"""### Table 11 Export"""

table_11.to_excel(
    "Table_11_DCA_Results.xlsx",
    index=False
)

print("Table 11 exported successfully to 'Table_11_DCA_Results.xlsx'.")