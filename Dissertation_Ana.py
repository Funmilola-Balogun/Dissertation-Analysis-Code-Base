...
print("Figure 4.3 saved to 'Figure_4_3_Outcome_Distribution.png'.")
plt.show()
...
plt.savefig(
    'Figure_4_7_Calibration_Curve.png',
    dpi=300,
    bbox_inches='tight'
)

print("Figure 17 Calibration Curve saved to 'Figure_4_4_Calibration_Curve.png'.")
...
print("Table 8 exported successfully to 'Table_4_7_Linear_Regression_Performance.xlsx'.")
...
This section can be used to list any relevant resources, such as:
*   Links to original data sources
*   References to research papers or documentation
*   Libraries used or key algorithms explained
*   A summary of findings or future work
"""
